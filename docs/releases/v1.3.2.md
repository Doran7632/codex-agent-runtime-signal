# codex-agent-runtime-signal v1.3.2
...
- [CodexAgentRuntimeSignal.dmg](https://github.com/guan-ops/codex-agent-runtime-signal/releases/download/v1.3.2/CodexAgentRuntimeSignal.dmg)
- [CodexAgentRuntimeSignal.zip](https://github.com/guan-ops/codex-agent-runtime-signal/releases/download/v1.3.2/CodexAgentRuntimeSignal.zip)
- [CodexAgentRuntimeSignal-SHA256SUMS.txt](https://github.com/guan-ops/codex-agent-runtime-signal/releases/download/v1.3.2/CodexAgentRuntimeSignal-SHA256SUMS.txt)
- [CodexAgentRuntimeSignal-release-manifest.json](https://github.com/guan-ops/codex-agent-runtime-signal/releases/download/v1.3.2/CodexAgentRuntimeSignal-release-manifest.json)
- [Full changelog since v1.3.0](https://github.com/guan-ops/codex-agent-runtime-signal/compare/v1.3.0...v1.3.2)
...
- [CodexAgentRuntimeSignal-SHA256SUMS.txt](https://github.com/guan-ops/codex-agent-runtime-signal/releases/download/v1.3.2/CodexAgentRuntimeSignal-SHA256SUMS.txt)
- [CodexAgentRuntimeSignal-release-manifest.json](https://github.com/guan-ops/codex-agent-runtime-signal/releases/download/v1.3.2/CodexAgentRuntimeSignal-release-manifest.json)
- [从 v1.3.0 起的完整变更记录](https://github.com/guan-ops/codex-agent-runtime-signal/compare/v1.3.0...v1.3.2)
