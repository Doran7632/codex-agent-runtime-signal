# codex-agent-runtime-signal v1.3.3
...
- [CodexAgentRuntimeSignal.dmg](https://github.com/guan-ops/codex-agent-runtime-signal/releases/download/v1.3.3/CodexAgentRuntimeSignal.dmg)
- [CodexAgentRuntimeSignal.zip](https://github.com/guan-ops/codex-agent-runtime-signal/releases/download/v1.3.3/CodexAgentRuntimeSignal.zip)
- [CodexAgentRuntimeSignal-SHA256SUMS.txt](https://github.com/guan-ops/codex-agent-runtime-signal/releases/download/v1.3.3/CodexAgentRuntimeSignal-SHA256SUMS.txt)
- [CodexAgentRuntimeSignal-release-manifest.json](https://github.com/guan-ops/codex-agent-runtime-signal/releases/download/v1.3.3/CodexAgentRuntimeSignal-release-manifest.json)
- [Full changelog since v1.3.2](https://github.com/guan-ops/codex-agent-runtime-signal/compare/v1.3.2...v1.3.3)
...
- [CodexAgentRuntimeSignal-SHA256SUMS.txt](https://github.com/guan-ops/codex-agent-runtime-signal/releases/download/v1.3.3/CodexAgentRuntimeSignal-SHA256SUMS.txt)
- [CodexAgentRuntimeSignal-release-manifest.json](https://github.com/guan-ops/codex-agent-runtime-signal/releases/download/v1.3.3/CodexAgentRuntimeSignal-release-manifest.json)
- [从 v1.3.2 起的完整变更记录](https://github.com/guan-ops/codex-agent-runtime-signal/compare/v1.3.2...v1.3.3)
