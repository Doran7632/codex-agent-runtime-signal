...
public struct SessionRecord: Codable, Equatable, Sendable {
    ...
    public var signal: RuntimeSignal
...
public struct SignalStateDocument: Codable, Equatable, Sendable {
    ...
    public var aggregate: RuntimeSignal?
    public var updatedAt: Date?
    ...
    public init(from decoder: Decoder) throws {
        ...
        aggregate = try container.decodeIfPresent(RuntimeSignal.self, forKey: .aggregate)
...
public extension SignalStateDocument {
    ...
    func aggregateSignal() -> RuntimeSignal {
