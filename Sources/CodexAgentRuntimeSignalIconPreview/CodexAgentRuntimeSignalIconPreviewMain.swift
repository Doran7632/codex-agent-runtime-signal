...
@MainActor
@main
struct CodexAgentRuntimeSignalIconPreview {
    ...
    private static func renderSheet(records: [PreviewRecord], to outputURL: URL) throws {
        ...
        drawText(
            "codex-agent-runtime-signal status bar preview",
...
private enum PreviewError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .usage:
            return "usage: codex-agent-runtime-signal-icon-preview [output-dir] or codex-agent-runtime-signal-icon-preview --output <dir>"
